...
RUN git clone --branch crw-2.12.0 --single-branch https://github.com/${THEIA_GITHUB_REPO} ${HOME}/theia-source-code && \
...
FROM registry.access.redhat.com/ubi8/nodejs-12:1-98 as build-result
USER root
...
# Use node image
# https://access.redhat.com/containers/?tab=tags#/registry.access.redhat.com/ubi8/nodejs-12
FROM registry.access.redhat.com/ubi8/nodejs-12:1-98 as runtime
