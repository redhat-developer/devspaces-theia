...
FROM registry.access.redhat.com/ubi8/nodejs-14:1-99.1675799486 as build-result
USER root
...
# Use node image
# https://access.redhat.com/containers/?tab=tags#/registry.access.redhat.com/ubi8/nodejs-14
FROM registry.access.redhat.com/ubi8/nodejs-14:1-99.1675799486 as runtime
USER 0
RUN yum -y -q update && \
