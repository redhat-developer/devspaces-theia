...
# Builder Image
#
FROM quay.io/devspaces/theia-dev-rhel8:next as builder
...
FROM registry.access.redhat.com/ubi8/nodejs-14:1-75.1654147935 as build-result
USER root
...
# Use node image
# https://access.redhat.com/containers/?tab=tags#/registry.access.redhat.com/ubi8/nodejs-14
FROM registry.access.redhat.com/ubi8/nodejs-14:1-75.1655143375 as runtime
USER 0
RUN yum -y -q update && \
